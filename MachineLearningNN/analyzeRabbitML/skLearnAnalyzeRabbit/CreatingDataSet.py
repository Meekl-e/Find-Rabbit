...
class GeneratingRabbits:
    ...
    def generatingRabbits(self):
        ...
        file = open("MachineLearningNN/analyzeRabbitML/skLearnAnalyzeRabbit/datasets/dataRabbits.txt", "w")
        ...
        fileTest = open("MachineLearningNN/analyzeRabbitML/skLearnAnalyzeRabbit/datasets/dataTestRabbits.txt", "w")
    ...
    def generatingNoRabbits(self):
        ...
        file = open("MachineLearningNN/analyzeRabbitML/skLearnAnalyzeRabbit/datasets/dataNoRabbits.txt", "w")
        file.writelines(noRabbits)

        noRabbits.clear()
        file.close()

        fileTest = open("MachineLearningNN/analyzeRabbitML/skLearnAnalyzeRabbit/datasets/dataTestNoRabbit.txt", "w")
